...
CREATE TABLE department (id SERIAL NOT NULL, parent_ref INT DEFAULT NULL, level TEXT NOT NULL, path TEXT DEFAULT '/' NOT NULL, code VARCHAR, name_fr TEXT NOT NULL, name_en TEXT NOT NULL, name_nl TEXT NOT NULL, is_active BOOLEAN DEFAULT 'true' NOT NULL, PRIMARY KEY(id));
CREATE UNIQUE INDEX unq_department_codee ON department (code);
...
COMMENT ON COLUMN department.code IS 'Unique code given to department/section';
